...
class Case空间信息(unittest.TestCase):
    ...
    def test_空间信息_01(self):
        ...
        """
        #新增空间
        feild_add_space = Param_空间信息.p_add.get('数据不正确')
        feild_add_space['buildingFloorSpaceName'] = "room "+str(uuid.uuid1())
        rsp_data=Page楼层房间信息表管理.api_新增楼层房间信息表(self.session,feild_add_space,self.header)
    ...
    def test_空间信息_02(self):
        ...
        :return:
        """
        res_data = Page区域或楼栋表管理.api_区域或楼栋通过id查询(self.session, str(456465), self.header)
    ...
    def test_空间信息_03(self):
        ...
        :return:
        """
        res_data = Page楼层房间信息表管理.api_楼层房间信息通过id删除(self.session,str(41231),self.header)
    ...
    def test_空间信息_04(self):
        ...
        feild_add_space = Param_空间信息.p_add.get('数据不正确')
        feild_add_space['buildingFloorSpaceName'] = "room " + str(uuid.uuid1())
        rsp_data = Page楼层房间信息表管理.api_修改楼层房间信息表(self.session, feild_add_space, self.header)
        self.assertNotEqual(rsp_data["code"], 200)
