...
class Page企业员工(object):
    ...
    @classmethod
    def api_修改企业员工(cls, session: requests.Session, feilds: dict, header: dict):
        api_name = 'api_修改企业员工'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
        header.update(Browser_Param.headers.get('json').copy())
    ...
    @classmethod
    def api_企业员工重置密码(cls, session: requests.Session, feilds: dict, header: dict):
        api_name = 'api_企业员工重置密码'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
        header.update(Browser_Param.headers.get('json').copy())
        r = session.put(url, headers=header, json=feilds)
        try:
    ...
    @classmethod
    def api_企业员工启用禁用(cls, session: requests.Session, feilds: dict, header: dict):
        api_name = 'api_企业员工启用禁用'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
        header.update(Browser_Param.headers.get('json').copy())
        r = session.put(url, headers=header, json=feilds)
        try:
    ...
    @classmethod
    def api_通过id查询企业员工(cls, session: requests.Session, id: str,header:dict):
        api_name = 'api_通过id查询企业员工'
    ...
    @classmethod
    def api_批量导入员工模板(cls, session: requests.Session,  header: dict):
        api_name = 'api_批量导入员工模板'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
        header.update(Browser_Param.headers.get('form').copy())
        r = session.get(url, headers=header)
        try:
