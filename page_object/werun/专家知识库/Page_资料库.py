...
class Page资料库(object):
    ...
    @classmethod
    def api_编辑资料库(cls, session: requests.Session, feilds: dict, header: dict):
        api_name = 'api_编辑资料库'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
        header.update(Browser_Param.headers.get('json').copy())
    ...
    @classmethod
    def api_id查询资料库(cls, session: requests.Session, id: str, header: dict):
        api_name = 'api_id查询资料库'
    ...
    @classmethod
    def api_列表查询树状资料库(cls, session: requests.Session, header: dict):
        api_name = 'api_查询树状数据'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
        header.update(Browser_Param.headers.get('json').copy())
    ...
    @classmethod
    def api_新增项目资料(cls, session: requests.Session, feilds: dict, header: dict):
        api_name = 'api_新增项目资料'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
        header.update(Browser_Param.headers.get('json').copy())
        r = session.post(url, headers=header, json=feilds)
    ...
    @classmethod
    def api_分页查询项目资料(cls, session: requests.Session, feilds: dict, header: dict):
        api_name = 'api_分页查询项目资料'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
        header.update(Browser_Param.headers.get('json').copy())
        r = session.post(url, headers=header, json=feilds)
        Common_Base.logging_api_info(api_name, url, str(header), r.text, str(feilds))
    ...
    @classmethod
    def api_删除项目资料(cls, session: requests.Session, id: str, header: dict):
        api_name = 'api_删除项目资料'
        url = Api_Addr_WeRun.werun_apis.get(api_name) + id
        header.update(Browser_Param.headers.get('form').copy())
        r = session.delete(url, headers=header)
