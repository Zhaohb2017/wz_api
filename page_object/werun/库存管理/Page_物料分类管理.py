...
class Page物料分类管理(object):

    @classmethod
    def api_新增物料分类(cls, session: requests.Session, feilds: dict,header:dict):
        api_name = 'api_新增物料分类'
    ...
    @classmethod
    def api_修改物料分类(cls, session: requests.Session, feilds: dict,header:dict):
        api_name = 'api_修改物料分类'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
        header.update(Browser_Param.headers.get('json').copy())
    ...
    @classmethod
    def api_物料类修改预警值(cls, session: requests.Session, feilds: dict,header:dict):
        api_name = 'api_物料类修改预警值'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
        header.update(Browser_Param.headers.get('json').copy())
        r = session.put(url, headers=header, json=feilds)
        Common_Base.logging_api_info(api_name, url, str(header) ,r.text, str(feilds),request_method=r.request.method)
    ...
    @classmethod
    def api_物料分类集合查询(cls, session: requests.Session,header:dict):
        api_name = 'api_物料分类集合查询'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
        header.update(Browser_Param.headers.get('json').copy())
    ...
    @classmethod
    def api_物料分类分页查询(cls, session: requests.Session,feilds:dict,header:dict):
        api_name = 'api_物料分类分页查询'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
        header.update(Browser_Param.headers.get('json').copy())
        r = session.post(url, headers=header,json=feilds)
    ...
    @classmethod
    def api_库存预警分页查询(cls, session: requests.Session,feilds:dict,header:dict):
        api_name = 'api_库存预警分页查询'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
        header.update(Browser_Param.headers.get('json').copy())
        r = session.post(url, headers=header,json=feilds)
        Common_Base.logging_api_info(api_name, url, str(header) ,r.text,str(feilds))
    ...
    @classmethod
    def api_物料分类名称集合查询(cls, session: requests.Session,header:dict):
        api_name = 'api_物料分类名称集合查询'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
    ...
    @classmethod
    def api_通过id删除物料分类(cls, session: requests.Session, id: str,header:dict):
        api_name = 'api_通过id删除物料分类'
