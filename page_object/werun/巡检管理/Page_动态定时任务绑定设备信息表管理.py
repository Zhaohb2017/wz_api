...
class Page动态定时任务绑定设备信息表管理(object):

    @classmethod
    def api_新增动态定时任务绑定设备信息表(cls, session: requests.Session, feilds: dict,header:dict):
        api_name = 'api_新增动态定时任务绑定设备信息表'
    ...
    @classmethod
    def api_修改动态定时任务绑定设备信息表(cls, session: requests.Session, feilds: dict,header:dict):
        api_name = 'api_修改动态定时任务绑定设备信息表'
        url = Api_Addr_WeRun.werun_apis.get(api_name)
        header.update(Browser_Param.headers.get('json').copy())
    ...
    @classmethod
    def api_动态定时任务绑定设备信息通过id查询(cls, session: requests.Session, id: str,header:dict):
        api_name = 'api_动态定时任务绑定设备信息通过id查询'
    ...
    @classmethod
    def api_动态定时任务绑定设备信息通过id删除(cls, session: requests.Session, id: str,header:dict):
        api_name = 'api_动态定时任务绑定设备信息通过id删除'
        url = Api_Addr_WeRun.werun_apis.get(api_name)+id
        header.update(Browser_Param.headers.get('form').copy())
